			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="matriculaFuncional" title="${message(code: 'professor.matriculaFuncional.label', default: 'Matricula Funcional')}" />
				...
				<g:each in="${professorInstanceList}" status="i" var="professorInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: professorInstance, field: "matriculaFuncional")}</td>
