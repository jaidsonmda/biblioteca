			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="nomeTurma" title="${message(code: 'turma.nomeTurma.label', default: 'Nome Turma')}" />
				...
				<g:each in="${turmaInstanceList}" status="i" var="turmaInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${turmaInstance.id}">${fieldValue(bean: turmaInstance, field: "nomeTurma")}</g:link></td>
