	...
	<body>
		...
		<div id="show-turma" class="content scaffold-show" role="main">
			...
			<ol class="property-list turma">
				...
				<g:if test="${turmaInstance?.nomeTurma}">
				<li class="fieldcontain">
					<span id="nomeTurma-label" class="property-label"><g:message code="turma.nomeTurma.label" default="Nome Turma" /></span>
					
						<span class="property-value" aria-labelledby="nomeTurma-label"><g:fieldValue bean="${turmaInstance}" field="nomeTurma"/></span>
