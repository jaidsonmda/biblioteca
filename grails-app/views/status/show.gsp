	...
	<body>
		...
		<div id="show-status" class="content scaffold-show" role="main">
			...
			<ol class="property-list status">
				...
				<g:if test="${statusInstance?.nome}">
				<li class="fieldcontain">
					<span id="nome-label" class="property-label"><g:message code="status.nome.label" default="Nome" /></span>
					
						<span class="property-value" aria-labelledby="nome-label"><g:fieldValue bean="${statusInstance}" field="nome"/></span>
