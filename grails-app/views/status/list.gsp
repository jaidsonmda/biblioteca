			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="nome" title="${message(code: 'status.nome.label', default: 'Nome')}" />
				...
				<g:each in="${statusInstanceList}" status="i" var="statusInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${statusInstance.id}">${fieldValue(bean: statusInstance, field: "nome")}</g:link></td>
