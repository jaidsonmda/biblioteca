			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="issbn" title="${message(code: 'livro.issbn.label', default: 'Issbn')}" />
					
						<g:sortableColumn property="ano" title="${message(code: 'livro.ano.label', default: 'Ano')}" />
					
						<g:sortableColumn property="idioma" title="${message(code: 'livro.idioma.label', default: 'Idioma')}" />
				...
				<g:each in="${livroInstanceList}" status="i" var="livroInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: livroInstance, field: "issbn")}</td>
					
						<td>${fieldValue(bean: livroInstance, field: "ano")}</td>
					
						<td>${fieldValue(bean: livroInstance, field: "idioma")}</td>
